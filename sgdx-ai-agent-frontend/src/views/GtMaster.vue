...
// 设置页面标题和元数据
useHead({
  title: '高套智慧助手 - 韶关电信业支智能体应用平台',
  meta: [
    {
      name: 'description',
      content: '高套智慧助手是韶关电信业支智能体应用平台的专业核查助手，帮你解答各种高套问题，如高套局向，揽装人，为何不折算高套'
    },
    {
      name: 'keywords',
      content: '高套智慧助手,高套核查,AI聊天,韶关电信业支,AI智能体'
    }
  ]
})
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到高套智慧助手，请告诉我你的高套核查问题，我会尽力给予帮助和建议。', false)
})
