  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">韶关电信业支智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">高套智慧助手</div>
          <div class="app-desc">核查高套是否折算，解答你对高套的疑惑</div>
        </div>
      ...
      <div class="app-card" @click="navigateTo('/super-agent')">
        ...
        <div class="app-info">
          <div class="app-title">薪酬申诉助手</div>
          <div class="app-desc">全能型AI助手帮你集约考核申诉</div>
        </div>
        <div class="app-button">
          <span class="btn-text">立即体验</span>
          <span class="btn-icon">→</span>
...
// 设置页面标题和元数据
useHead({
  title: '韶关业支AI智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: '韶关业支AI智能体应用平台提供AI核查高套和AI薪酬申诉服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI核查高套,AI助手,智能对话,AI薪酬申诉,首页'
    }
  ]
})
